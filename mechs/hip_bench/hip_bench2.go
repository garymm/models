...
//	TheSim.Config()
//
//	TrueSim.Net = TheSim.Net //This is just to override it's call
//	TrueSim.ConfigLogs()
//
//	if len(os.Args) > 1 {
...
//type Sim struct {
//	HipSim *HipSim //for the gradual replacement of stuff
//	//SimUpdated   *simsuccesor.Sim         `desc:"the worm that burrows in and replaces this sim object"`
//
